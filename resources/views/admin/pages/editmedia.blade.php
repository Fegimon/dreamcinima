            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" class="form-control" value="{{$mediars->media_title}}" id="media_title" name="media_title" data-mask placeholder="Media Title" required>
               ...
               <label>Media Description</label>
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" class="form-control" value="{{$mediars->media_desc}}" id="media_desc" name="media_desc" placeholder="Media Description" data-mask required>
               ...
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" class="form-control" value="{{$mediars->media_url}}" id="media_url" name="media_url" placeholder="Media Url" data-mask required>
                  </div>
               </div>
